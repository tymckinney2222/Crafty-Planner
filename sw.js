...
const CACHE_NAME = 'crafty-planner-v4';
const STATIC_ASSETS = [
  './manifest.json',
...
self.addEventListener('fetch', event => {
  ...
  // index.html — NETWORK FIRST with no-cache to bypass browser HTTP cache
  // (GitHub Pages sends max-age=600 by default; without this, the browser's HTTP cache
  // can serve stale HTML even though the SW asked for "network-first")
